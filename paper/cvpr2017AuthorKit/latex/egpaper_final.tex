...
crops of \Cref{fig:recon} (brain $R{=}4$, $T{=}50$). FA-KGD's gain
($+0.43$/$+0.46$~dB) persists at high-variance edges.}
\label{tab:crops}
...
\midrule
Full slice (ref.) & 30.27 & 30.82 & $+0.55$ & .869 & .881 & $+.011$ \\
\bottomrule
\end{tabular}
\end{table}
...
volume size. \PIGDM{} peaks at $T{=}50$ then degrades, the signature of
